		...
		if (Pixastic.Client.hasCanvasImageData()) {
			...
			do {
				...
				do {
					...
					/*
					if(r < 3 && g < 3 && b < 3){r = 0; g=0; b= 100;}
					if(r < 50 && g < 50 && b < 50 && r > 3 && g > 3 && b > 3){r = 255; g=0; b=0;}
					if(r < 100 && g < 100 && b < 100 && r > 50 && g > 50 && b > 50){r = 0; g=255; b=0;}
					if(r < 150 && g < 150 && b < 150 && r > 100 && g > 100 && b > 100){r = 155; g=155; b=0;}
					if(r < 200 && g < 200 && b < 200 && r > 150 && g > 150 && b > 150){r = 0; g=155; b=155;}
					if(r < 200 && g < 255 && b < 255 && r > 255 && g > 200 && b > 200){r = 0; g=155; b=155;}
					*/
