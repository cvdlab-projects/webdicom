...
DcmApp.prototype.load_files = function(files)
{
	...
	console.log(files.length-1); 	//Restituisce il valore dell'array dei file caricati, utile come indice del ciclo for.
											//Le operazioni sul caricamento di tutte le immagini nei canvas lo posso fare direttamente da qui.
...
DcmApp.prototype.init = function() {
    ...
    window.onresize = function(evt) {
        ...
        function resize_canvas() {
            ...
            var c_new = document.getElementById('myCanvas_1');
